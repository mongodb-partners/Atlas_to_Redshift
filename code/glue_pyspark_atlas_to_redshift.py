...
redshift_datasink = glueContext.write_dynamic_frame.from_jdbc_conf(frame = applymapping1, catalog_connection = "Redshift", connection_options = {"dbtable": "dev", "database": "customer_activity"}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "redshift_datasink")
job.commit()
